...
from src.utils import load_operations, date_format, five_last_operations, sorted_by_date, bank_account_hide
...
def test_sorted_by_date():
    ...
    assert date_sorted(test_date_1) == [
        {"date": "2019-09-11T17:30:34.445824"},
        {"date": "2019-07-12T08:11:47.735774"},
        {"date": "2018-08-19T04:27:37.904916"}
    ]
...
def test_bank_account_hide():
    ...
    assert bank_account_hide(test_account1) == "Visa Classic 419519******3802"
